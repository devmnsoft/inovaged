...
{
    public static int SmartPreflight(string root,TextWriter output,TextWriter error)=>Run("Smart preflight",output,error,new()
    {
    ...
    public static int Recommendation(string root,TextWriter output,TextWriter error)=>Run("Template recommendation",output,error,new()
    {
    ...
    public static int DesignerAssist(string root,TextWriter output,TextWriter error)=>Run("Designer assist",output,error,new()
    {
    ...
    public static int PublishQuality(string root,TextWriter output,TextWriter error)=>Run("Publish quality",output,error,new()
    {

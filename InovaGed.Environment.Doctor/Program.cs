...
try
{
    ...
    var allowed = new[] { "quality-gate", "schema", "schema-check", "di", "di-check", "routes", "route-smoke", "razor", "razor-check", "icons", "icon-check", "dapper-mapping", "admin-links-check", "layout-check", "incidents", "uat-readiness" };

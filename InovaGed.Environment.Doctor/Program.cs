...
try
{
    ...
    var allowed = new[] { "quality-gate", "schema", "schema-check", "di", "di-check", "routes", "route-smoke", "razor", "razor-check", "icons", "icon-check", "dapper-mapping", "admin-links-check", "layout-check", "incidents", "uat-readiness", "ui-consistency" };
    ...
    IQualityCheck[] all=[new MigrationFileQualityCheck(),new DependencyInjectionQualityCheck(),new PostgresSchemaQualityCheck(),new RazorQualityCheck(),new IconQualityCheck(),new RouteSmokeQualityCheck(),new AdministrationLinksQualityCheck(),new LayoutQualityCheck(),new UiConsistencyQualityCheck(),new DapperMappingQualityCheck(),new IncidentCenterQualityCheck(),new UatReadinessQualityCheck()];

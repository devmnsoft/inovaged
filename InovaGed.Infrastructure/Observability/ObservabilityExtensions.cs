    ...
    public static IServiceCollection AddInovaGedObservability(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var resource = ResourceBuilder.CreateDefault()
            ...
            .AddAttributes(new Dictionary<string, object>
            {
                ...
                ["inovaged.cluster.id"] = configuration["Cluster:ClusterId"] ?? "single",
                ["inovaged.cluster.mode"] = configuration["Cluster:Mode"] ?? "SingleNode",
                ["inovaged.node.id"] = nodeId,
                ["inovaged.node.color"] = configuration["Cluster:NodeColor"] ?? "none",
                ["inovaged.region"] = configuration["Cluster:Region"] ?? "unspecified",
                ["inovaged.availability_zone"] = configuration["Cluster:AvailabilityZone"] ?? "unspecified",
                ["inovaged.commit.sha"] = configuration["Build:CommitSha"] ?? "unknown"
            });

...
(id, tenant_id, code, name, description, parent_id, activity_type, sort_order, current_term_text, current_event, intermediate_term_text, intermediate_event, normative_source, condition_or_exception, review_status,
...
values
(gen_random_uuid(), @tenant_id, @code, @name, @description, @parent_id, @activity_type, @sort_order, @current_term_text, @current_event, @intermediate_term_text, @intermediate_event, @normative_source, @condition_or_exception, @review_status,
...
";
            var id = await conn.ExecuteScalarAsync<Guid>(new CommandDefinition(sql, new
            {
                ...
                activity_type = vm.ActivityType, sort_order = vm.SortOrder, current_term_text = vm.CurrentTermText, current_event = vm.CurrentEvent,
                intermediate_term_text = vm.IntermediateTermText, intermediate_event = vm.IntermediateEvent, normative_source = vm.NormativeSource,
                condition_or_exception = vm.ConditionOrException, review_status = vm.ReviewStatus,
...
set code=@code,
    ...
    parent_id=@parent_id,
    activity_type=@activity_type, sort_order=@sort_order, current_term_text=@current_term_text, current_event=@current_event,
    intermediate_term_text=@intermediate_term_text, intermediate_event=@intermediate_event, normative_source=@normative_source,
    condition_or_exception=@condition_or_exception, review_status=@review_status,

...
public sealed class DocumentBulkUploadService : IDocumentBulkUploadService
{
    ...
    public DocumentBulkUploadService(DocumentAppService documentApp, IAuditWriter audit, ILogger<DocumentBulkUploadService> logger){_documentApp=documentApp;_audit=audit;_logger=logger;}

...
public sealed class SchemaHealthService : ISchemaHealthService
{
    ...
    [
        ...
        ("upload_batch", "created_by_name", "Upload batch"), ("upload_batch", "requested_folder_id", "Upload batch"), ("upload_batch_item", "batch_id", "Upload batch"),
        ("upload_batch_item", "upload_session_id", "Upload batch"), ("upload_batch_item", "uploaded_by_name", "Upload batch"), ("upload_batch_item", "status", "Upload batch"),

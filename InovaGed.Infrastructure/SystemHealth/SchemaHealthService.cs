...
public sealed class SchemaHealthService : ISchemaHealthService
{
    ...
    [
        ...
        "ged.label_print", "ged.physical_location", "ged.physical_box", "ged.physical_box_document",
        "ged.physical_movement", "ged.physical_inventory_session", "ged.physical_inventory_item",
        ...
        "ged.brand_asset", "ged.print_logo_selection", "ged.print_logo_layout_validation", "ged.print_brand_profile", "ged.print_template_brand_binding"
    ];
    ...
    [
        ...
        ("ix_document_version_tenant_document_reg_status", [], "Índice de versões por documento/status lógico."),
...
limit 1;", cancellationToken: ct));
    ...
    private static string BuildIndexId(string indexName)
    {
        return indexName.ToLowerInvariant() switch
        {
            ...
            "ix_document_version_tenant_document_reg_status" => "GED_INDEX_DOCUMENT_VERSION_TENANT_DOCUMENT_REG_STATUS",

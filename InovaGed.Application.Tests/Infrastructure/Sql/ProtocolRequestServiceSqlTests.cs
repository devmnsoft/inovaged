...
public sealed class ProtocolRequestServiceSqlTests
{
    ...
    public void BuildListMySql_WithDateRange_IsValid()
        => AssertProtocolSqlIsValid(ProtocolRequestService.BuildListMySql(UserId, new ProtocolVisibilityScope(), new ProtocolWorkQueueFilter { From = FixedNow.AddDays(-7), To = FixedNow }, out var parameters), parameters, "@From", "@To");

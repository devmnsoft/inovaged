...
public enum SignatureType { INTERNAL, CADES, PADES, IMPORTED, REMOTE_PROVIDER }
public enum SigningProcessStatus { REQUESTED, WAITING_SIGNER, SIGNING, SIGNED, VALIDATING, COMPLETED, FAILED, CANCELLED, EXPIRED }
public enum SignatureValidationStatus { VALID, INVALID, INDETERMINATE, NOT_VERIFIABLE, REVOKED, EXPIRED, NOT_YET_VALID, UNTRUSTED_CHAIN, POLICY_INVALID, CPF_MISMATCH, CERTIFICATE_PURPOSE_INVALID, TIMESTAMP_INVALID, DOCUMENT_CHANGED, SIGNATURE_CORRUPTED, INTERNAL_ONLY }

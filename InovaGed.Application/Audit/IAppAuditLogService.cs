...
public interface IAppAuditLogService
{
    ...
    Task LogBusinessAsync(Guid? tenantId, Guid? userId, string action, string entityName, string? entityId, string message, object? data = null, CancellationToken ct = default);

        ...
        CancellationToken ct)
    {
        ...
        try
        {
            ...
            await _writeRepo.InsertVersionAsync(new DocumentVersionRow
            {
                ...
                PartialGroupId = cmd.PartialGroupId,
                PartialPartNumber = cmd.PartialPartNumber ?? cmd.PartNumber,
                PartialTotalParts = cmd.PartialTotalParts ?? cmd.TotalParts,
                PartialStatus = cmd.IsPartialDocument ? (cmd.IsDocumentIncomplete ? "INCOMPLETE" : cmd.PartialStatus) : "NOT_PARTIAL",
                IsDocumentIncomplete = cmd.IsDocumentIncomplete,

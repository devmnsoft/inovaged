...
public sealed class DocumentMoveRequestVM { public Guid DocumentId { get; set; } public Guid DestinationFolderId { get; set; } public Guid? RequestedFolderId { get; set; } public string? Reason { get; set; } public string? Source { get; set; } }
public sealed class DocumentBulkMoveRequestVM { public List<Guid>? DocumentIds { get; set; } = new(); public bool AllOrNothing { get; set; } public string? IdempotencyKey { get; set; } public Guid DestinationFolderId { get; set; } public Guid? RequestedFolderId { get; set; } public string? Reason { get; set; } public string? Source { get; set; } }

...
public sealed class DocumentMoveResultDto { public Guid DocumentId { get; set; } public bool Success { get; set; } public string? Message { get; set; } public Guid? OldFolderId { get; set; } public Guid? NewFolderId { get; set; } }

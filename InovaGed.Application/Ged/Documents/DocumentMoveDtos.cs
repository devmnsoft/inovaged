...
public sealed class DocumentBulkMoveRequestVM { public List<Guid> DocumentIds { get; set; } = new(); public Guid DestinationFolderId { get; set; } public Guid? RequestedFolderId { get; set; } public string? Reason { get; set; } public string? Source { get; set; } }

...
6. O registro auxiliar em `ged.report_export_audit` somente é executado quando a tabela existe.
...
3. Remover, em uma base descartável, uma estrutura opcional de OCR/classificação e confirmar o fallback sem HTTP 500.

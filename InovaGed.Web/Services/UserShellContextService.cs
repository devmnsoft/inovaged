    ...
    private static IReadOnlyList<AppMenuSectionVM> BuildMenu(ClaimsPrincipal user)
    {
        if (AppMenuPolicy.IsFullAdmin(user))
        {
            return new[]
            {
                ...
                Section("Acervo Físico",
                    Item("Dashboard Físico", "Physical", "Index", "dashboard"),
                    Item("Lotes", "Batches", "Index", "cards"),
                    Item("Caixas", "Physical", "Boxes", "documents"),
                    Item("Localizações", "Physical", "Locations", "map"),
                    Item("Movimentações", "Physical", "Movements", "recent"),
                    Item("Inventário", "Physical", "Inventory", "check"),
                    Item("Empréstimos", "Physical", "Loans", "loan"),
                    Item("Cadeia de Custódia", "Physical", "Boxes", "audit"),

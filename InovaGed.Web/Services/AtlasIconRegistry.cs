...
public sealed class AtlasIconRegistry : IAtlasIconRegistry
{
    private static readonly IReadOnlyCollection<AtlasIconDefinition> Definitions = new AtlasIconDefinition[]
    {
        ...
        new("permissions", "atlas-icon-permissions", "Usuários", "permissions", "outline", new[] { "security", "bi-person-lock" }),
        ...
        new("physical-archive", "atlas-icon-physical-archive", "Arquivo físico", "physical archive", "outline", new[] { "archive", "bi-building" }),
        ...
        new("label", "atlas-icon-label", "Arquivo físico", "label", "outline", new[] { "tag" }),

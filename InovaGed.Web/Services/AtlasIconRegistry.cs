...
public sealed class AtlasIconRegistry : IAtlasIconRegistry
{
    private static readonly IReadOnlyCollection<AtlasIconDefinition> Definitions = new AtlasIconDefinition[]
    {
        ...
        new("report", "atlas-icon-report", "Auditoria", "report", "outline", new[] { "receipt" }),
        ...
        new("permissions", "atlas-icon-permissions", "Usuários", "permissions", "outline", new[] { "security", "shield", "shield-check", "key", "bi-person-lock" }),
        new("settings", "atlas-icon-settings", "Configurações", "settings", "outline", new[] { "sliders" }),
        ...
        new("list", "atlas-icon-list", "Ações", "list", "outline", new[] { "list-check" }),
        ...
        new("batch", "atlas-icon-batch", "Operações", "batch", "outline", new[] { "layers" }),

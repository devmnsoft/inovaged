...
using InovaGed.Infrastructure.WorkspaceSearch;
...
builder.Services.AddScoped<InovaGed.Application.Branding.IBrandAssetImageService, InovaGed.Infrastructure.Branding.BrandAssetImageService>();
...
builder.Services.AddScoped<InovaGed.Application.Labels.Canvas.ILabelCanvasComponentPresetService, InovaGed.Infrastructure.Labels.LabelCanvasComponentPresetService>();
builder.Services.AddScoped<InovaGed.Application.Labels.Canvas.ILabelTemplatePackageService, InovaGed.Infrastructure.Labels.LabelTemplatePackageService>();
...
builder.Services.AddSingleton<InovaGed.Application.Labels.Canvas.ILabelPublicationChecklistService, InovaGed.Infrastructure.Labels.LabelPublicationChecklistService>();
...
builder.Services.AddScoped<InovaGed.Application.Labels.Preview.ILabelPreviewService, InovaGed.Infrastructure.Labels.LabelPreviewService>();
builder.Services.AddScoped<InovaGed.Application.Labels.Batch.ILabelBatchPlanService, InovaGed.Infrastructure.Labels.LabelBatchPlanService>();
builder.Services.AddSingleton<InovaGed.Application.Labels.Automation.ILabelAutomationRuleEngine, InovaGed.Infrastructure.Labels.LabelAutomationRuleEngine>();
...
builder.Services.AddScoped<IConsistencyAuditService, InovaGed.Infrastructure.Administration.ConsistencyAuditService>();
builder.Services.AddScoped<IWorkspaceCommandCatalog, WorkspaceCommandCatalog>();
builder.Services.AddScoped<IWorkspaceSearchProvider, NavigationWorkspaceSearchProvider>();
builder.Services.AddScoped<IWorkspaceSearchProvider, DocumentWorkspaceSearchProvider>();
builder.Services.AddScoped<IWorkspaceSearchProvider, ProtocolWorkspaceSearchProvider>();
builder.Services.AddScoped<IWorkspaceSearchProvider, LoanWorkspaceSearchProvider>();
builder.Services.AddScoped<IWorkspaceSearchProvider, UserWorkspaceSearchProvider>();
...
builder.Services.AddScoped<ILoanOverdueService, LoanOverdueService>();
builder.Services.AddScoped<ILoanCollectionService, LoanCollectionService>();
builder.Services.AddScoped<ILoanReportService, LoanReportService>();
builder.Services.AddScoped<ProtocolRequestService>();
builder.Services.AddScoped<IProtocolRequestService>(sp => sp.GetRequiredService<ProtocolRequestService>());
builder.Services.AddScoped<IProtocolService>(sp => sp.GetRequiredService<ProtocolRequestService>());

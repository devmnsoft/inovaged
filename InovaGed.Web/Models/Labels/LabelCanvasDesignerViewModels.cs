...
public sealed record LabelDesignerIndexViewModel(IReadOnlyList<LabelTemplateListItemViewModel> Items,bool SchemaReady=true,string? SchemaMessage=null,bool SchemaActionAllowed=true);

...
""";
    ...
    private sealed class HospitalDocumentSearchRow { public Guid DocumentId { get; set; } public Guid VersionId { get; set; } public string Code { get; set; } = ""; public string Title { get; set; } = ""; public string FileName { get; set; } = ""; public string ContentType { get; set; } = ""; public long SizeBytes { get; set; } public DateTime CreatedAt { get; set; } public string Snippet { get; set; } = ""; public bool HasOcrText { get; set; } public double Rank { get; set; } public bool IsPartialDocument { get; set; } public bool IsDocumentIncomplete { get; set; } public string PartialStatus { get; set; } = "NOT_PARTIAL"; public int TotalRows { get; set; } public int TotalWithOcr { get; set; } public int TotalWithoutOcr { get; set; } public string TotalByType { get; set; } = "{}"; public string MatchSource { get; set; } = ""; public int MatchScore { get; set; } public string OcrStatus { get; set; } = ""; public string FolderName { get; set; } = ""; public string? FolderPath { get; set; } }

...
AND (@ocrRequired = FALSE OR (upper(COALESCE(oj.status::text,''))='COMPLETED' AND NULLIF(COALESCE(s.ocr_text,''),'') IS NOT NULL))
...
FROM filtered
CROSS JOIN LATERAL (SELECT count(*)::int AS "TotalRows", count(*) FILTER (WHERE upper(COALESCE("OcrStatus",''))='COMPLETED' AND NULLIF("OcrText", '') IS NOT NULL)::int AS "TotalWithOcr", count(*) FILTER (WHERE NOT (upper(COALESCE("OcrStatus",''))='COMPLETED' AND NULLIF("OcrText", '') IS NOT NULL))::int AS "TotalWithoutOcr" FROM filtered) agg
...
""";
    ...
    private HospitalDocumentSuggestionDto MapSuggestion(HospitalDocumentSuggestionRow x)
    {
        ...
        return new()
        {
            ...
            HasOcr = x.HasOcr && string.Equals(x.OcrStatus, "COMPLETED", StringComparison.OrdinalIgnoreCase),
            HasOcrText = x.HasOcr,
            IsOcrAvailable = x.HasOcr && string.Equals(x.OcrStatus, "COMPLETED", StringComparison.OrdinalIgnoreCase),
    ...
    private sealed class HospitalDocumentSearchRow { public Guid DocumentId { get; set; } public Guid VersionId { get; set; } public string Code { get; set; } = ""; public string Title { get; set; } = ""; public string FileName { get; set; } = ""; public string ContentType { get; set; } = ""; public long SizeBytes { get; set; } public DateTime CreatedAt { get; set; } public string Snippet { get; set; } = ""; public string OcrText { get; set; } = ""; public double Rank { get; set; } public bool IsPartialDocument { get; set; } public bool IsDocumentIncomplete { get; set; } public string PartialStatus { get; set; } = "NOT_PARTIAL"; public int TotalRows { get; set; } public int TotalWithOcr { get; set; } public int TotalWithoutOcr { get; set; } public string TotalByType { get; set; } = "{}"; public string MatchSource { get; set; } = ""; public int MatchScore { get; set; } public string OcrStatus { get; set; } = ""; public string FolderName { get; set; } = ""; public string? FolderPath { get; set; } }
    private sealed class HospitalDocumentSuggestionRow { public Guid DocumentId { get; set; } public Guid VersionId { get; set; } public string Code { get; set; } = ""; public string Title { get; set; } = ""; public string FileName { get; set; } = ""; public string ContentType { get; set; } = ""; public long SizeBytes { get; set; } public DateTime CreatedAt { get; set; } public string FolderName { get; set; } = ""; public string? FolderPath { get; set; } public bool HasOcr { get; set; } public bool HasOcrText { get; set; } public bool IsOcrAvailable { get; set; } public string OcrStatus { get; set; } = ""; public string MatchSource { get; set; } = ""; public string Snippet { get; set; } = ""; public double Rank { get; set; } public int MatchScore { get; set; } }
    private sealed class HospitalDocumentResultDto { public Guid DocumentId { get; set; } public Guid VersionId { get; set; } public string Code { get; set; } = ""; public string Title { get; set; } = ""; public string FileName { get; set; } = ""; public string ContentType { get; set; } = ""; public string Type { get; set; } = ""; public string FriendlyType { get; set; } = ""; public string FolderName { get; set; } = ""; public string? FolderPath { get; set; } public DateTime CreatedAt { get; set; } public string CreatedAtFormatted { get; set; } = ""; public long SizeBytes { get; set; } public string SizeFormatted { get; set; } = ""; public bool HasOcr { get; set; } public bool HasOcrText { get; set; } public bool IsOcrAvailable { get; set; } public string OcrStatus { get; set; } = ""; public string MatchSource { get; set; } = ""; public string MatchSourceLabel { get; set; } = ""; public int MatchScore { get; set; } public string Snippet { get; set; } = ""; public bool PreviewAvailable { get; set; } public string PreviewUrl { get; set; } = ""; public string ViewerUrl { get; set; } = ""; public string OcrUrl { get; set; } = ""; public bool IsPartialDocument { get; set; } public bool IsDocumentIncomplete { get; set; } public string PartialStatus { get; set; } = "NOT_PARTIAL"; public string PartialStatusLabel { get; set; } = ""; }
    private sealed class HospitalDocumentSuggestionDto { public string Group { get; set; } = "Documentos"; public string SuggestionType { get; set; } = "document"; public string Subtitle { get; set; } = ""; public string Icon { get; set; } = "bi-file-earmark-text"; public string Url { get; set; } = ""; public int Score { get; set; } public Guid DocumentId { get; set; } public Guid VersionId { get; set; } public string Code { get; set; } = ""; public string Title { get; set; } = ""; public string FileName { get; set; } = ""; public string ContentType { get; set; } = ""; public string Type { get; set; } = ""; public string FriendlyType { get; set; } = ""; public string FolderName { get; set; } = ""; public string? FolderPath { get; set; } public string CreatedAt { get; set; } = ""; public string Size { get; set; } = ""; public bool HasOcr { get; set; } public bool HasOcrText { get; set; } public bool IsOcrAvailable { get; set; } public string OcrStatus { get; set; } = ""; public string MatchSource { get; set; } = ""; public string MatchSourceLabel { get; set; } = ""; public string Snippet { get; set; } = ""; public string Label { get; set; } = ""; public string Description { get; set; } = ""; public string PreviewUrl { get; set; } = ""; public string ViewerUrl { get; set; } = ""; public string OcrUrl { get; set; } = ""; }

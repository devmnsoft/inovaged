...
public sealed class AdministrationController : Controller
{
    ...
    public async Task<IActionResult> Index(CancellationToken ct)
    {
        ...
        var actions = new[]
        {
            new AdministrationActionVM("GED Inteligente", "Análise documental, classificação sugerida, temporalidade assistida e busca inteligente.", "bi-stars", "SmartGed", "Index", AppPolicies.Administracao, "Inteligência e Workflow", true, null),
            new AdministrationActionVM("Assistente Documental", "Perguntas rastreáveis sobre acervo, documentos, etiquetas e temporalidade.", "bi-chat-dots", "SmartAssistant", "Index", AppPolicies.Administracao, "Inteligência e Workflow", true, null),
            new AdministrationActionVM("Workflow Inteligente", "Tarefas, SLA e pendências documentais geradas a partir da inteligência operacional.", "bi-diagram-3", "SmartWorkflow", "Index", AppPolicies.Administracao, "Inteligência e Workflow", true, null),
            new AdministrationActionVM("Governança Documental", "Auditoria, LGPD, riscos, evidências, alertas e relatórios executivos.", "shield-check", "Governance", "Index", AppPolicies.Administracao, "Governança e Segurança", true, null),
            ...
            new AdministrationActionVM("Banco e Migrations", "Valide compatibilidade do schema e prontidão de dados.", "bi-database-check", "Administration", "Migrations", AppPolicies.Administracao, "Banco de Dados e Ambiente", true, null),
            new AdministrationActionVM("Saúde do Sistema", "Acompanhe dependências e serviços essenciais.", "bi-heart-pulse", "Administration", "Health", AppPolicies.Administracao, "Banco de Dados e Ambiente", true, null),
            new AdministrationActionVM("Prontidão do Banco", "Valide conectividade, migrations e requisitos antes da operação.", "bi-database-check", "DatabaseReadiness", "Index", AppPolicies.Administracao, "Banco de Dados e Ambiente", true, null),

...
new AdministrationActionVM("Assistente Documental", "Perguntas rastreáveis sobre acervo, documentos, etiquetas e temporalidade.", "bi-chat-dots", "SmartAssistant", "Index", AppPolicies.Administracao, "Inteligência", true, null),
new AdministrationActionVM("Workflow Inteligente", "Tarefas, SLA e pendências documentais geradas a partir da inteligência operacional.", "bi-diagram-3", "SmartWorkflow", "Index", AppPolicies.Administracao, "Inteligência", true, null),

...
public sealed class LabelIntelligenceController(IDbConnectionFactory db,ILabelIntelligenceService intelligence,ILabelAlertService alerts,ILabelCustodyService custody):GedControllerBase(db)
{
 ...
 [HttpGet("WithoutLabel")] public async Task<IActionResult> WithoutLabel(string subjectType="BOX",CancellationToken ct){ViewBag.SubjectType=subjectType;return View(await intelligence.ListObjectsWithoutLabelAsync(TenantId,subjectType,ct));}

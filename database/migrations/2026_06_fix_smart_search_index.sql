...
BEGIN
    -- A extensão pode existir fora do search_path. Descobrir a função pelo
    -- catálogo e só então montar a chamada qualificada evita que o bloco seja
    -- compilado com uma referência inválida a unaccent(text).
    SELECT n.nspname

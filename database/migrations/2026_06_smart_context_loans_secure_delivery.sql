...
create index if not exists ix_search_context_term_synonyms_gin on ged.search_context_term using gin(synonyms);
...
('diabetes','clinical',array['diabete','DM','diabetes mellitus'],array['endocrinologia','glicemia','insulina'],2,true),
('AVC','clinical',array['acidente vascular cerebral','derrame'],array['neurologia','tomografia','prontuário'],2,true),
('APAC','administrative',array['autorização de procedimento','autorização de alta complexidade'],array['guia','autorização','oncologia'],2,false),
('ultrassom','document_type',array['ultrassonografia','USG'],array['exame','laudo'],1.5,false),
